package io.alive.tui.platform.swing;
 ...
 * (triggered by {@link io.alive.tui.platform.swing.SwingBackend#flush()}).
 *
...
public final class SwingTerminalPanel extends JPanel {
    ...
    private static KeyEvent translateKeyEvent(java.awt.event.KeyEvent e) {
        ...
        return switch (e.getKeyCode()) {
            case java.awt.event.KeyEvent.VK_ENTER     -> KeyEvent.of(io.alive.tui.event.KeyType.ENTER,     ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_BACK_SPACE-> KeyEvent.of(io.alive.tui.event.KeyType.BACKSPACE, ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_DELETE    -> KeyEvent.of(io.alive.tui.event.KeyType.DELETE,    ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_ESCAPE    -> KeyEvent.of(io.alive.tui.event.KeyType.ESCAPE);
            case java.awt.event.KeyEvent.VK_TAB       -> shift
                    ? KeyEvent.of(io.alive.tui.event.KeyType.SHIFT_TAB)
                    : KeyEvent.of(io.alive.tui.event.KeyType.TAB);
            case java.awt.event.KeyEvent.VK_UP        -> KeyEvent.of(io.alive.tui.event.KeyType.ARROW_UP,    ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_DOWN      -> KeyEvent.of(io.alive.tui.event.KeyType.ARROW_DOWN,  ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_LEFT      -> KeyEvent.of(io.alive.tui.event.KeyType.ARROW_LEFT,  ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_RIGHT     -> KeyEvent.of(io.alive.tui.event.KeyType.ARROW_RIGHT, ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_HOME      -> KeyEvent.of(io.alive.tui.event.KeyType.HOME,       ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_END       -> KeyEvent.of(io.alive.tui.event.KeyType.END,        ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_PAGE_UP   -> KeyEvent.of(io.alive.tui.event.KeyType.PAGE_UP,    ctrl, alt, shift);
            case java.awt.event.KeyEvent.VK_PAGE_DOWN -> KeyEvent.of(io.alive.tui.event.KeyType.PAGE_DOWN,  ctrl, alt, shift);
