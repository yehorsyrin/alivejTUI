...
public class Showcase extends Component {
    ...
    public void mount(Runnable onStateChange, EventBus eventBus) {
        ...
        for (io.github.yehorsyrin.tui.event.KeyType k : new io.github.yehorsyrin.tui.event.KeyType[]{
                io.github.yehorsyrin.tui.event.KeyType.ARROW_UP,
                io.github.yehorsyrin.tui.event.KeyType.ARROW_DOWN,
                io.github.yehorsyrin.tui.event.KeyType.ARROW_LEFT,
                io.github.yehorsyrin.tui.event.KeyType.ARROW_RIGHT,
                io.github.yehorsyrin.tui.event.KeyType.ENTER,
                io.github.yehorsyrin.tui.event.KeyType.TAB
        }) {
