 ...
 *   <li>{@link #readKey()} returns {@link io.github.yehorsyrin.tui.event.KeyType#EOF} only when the terminal
...
public interface TerminalBackend {
     ...
     * Returns {@link io.github.yehorsyrin.tui.event.KeyType#EOF} only on orderly end-of-input.
     *
