...
public class LayoutEngine {
    ...
    public void layout(Node root, int x, int y, int availableWidth, int availableHeight) {
        ...
        } else if (root instanceof io.github.yehorsyrin.tui.node.TextAreaNode ta) {
    ...
    private void layoutTextArea(io.github.yehorsyrin.tui.node.TextAreaNode ta, int availableWidth) {
