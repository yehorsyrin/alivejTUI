...
class ComponentTest {
    ...
    void renderThrows_defaultOnError_returnsErrorText() {
        ...
        assertInstanceOf(io.github.yehorsyrin.tui.node.TextNode.class, result);
        assertTrue(((io.github.yehorsyrin.tui.node.TextNode) result).getText().contains("kaboom"));
    }
    ...
    void customOnError_fallbackNodeReturned() {
        ...
        Node result = comp.renderAndCache();
        assertInstanceOf(io.github.yehorsyrin.tui.node.TextNode.class, result);
        assertEquals("fallback: state gone", ((io.github.yehorsyrin.tui.node.TextNode) result).getText());
    }
    ...
    void afterErrorFixed_renderRecovery() {
        ...
        assertInstanceOf(io.github.yehorsyrin.tui.node.TextNode.class, recovered);
        assertEquals("ok", ((io.github.yehorsyrin.tui.node.TextNode) recovered).getText());
    }
