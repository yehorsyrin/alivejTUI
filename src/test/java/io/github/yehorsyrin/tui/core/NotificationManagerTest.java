...
import io.github.yehorsyrin.tui.node.NotificationNode;
import io.github.yehorsyrin.tui.node.NotificationType;
...
/**
 * Tests for {@link NotificationManager} and {@link io.github.yehorsyrin.tui.node.NotificationNode}.
 *
 * @author Jarvis (AI)
 */
class NotificationManagerTest {
    ...
    void buildOverlay_multipleNotifications_returnsVBox() {
        ...
        m.show("A", 60_000L);
        m.show("B", 60_000L);
        assertInstanceOf(io.github.yehorsyrin.tui.node.VBoxNode.class, m.buildOverlay());
    }
}
