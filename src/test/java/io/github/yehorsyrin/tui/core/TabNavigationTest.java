...
import io.github.yehorsyrin.tui.node.Button;
...
class TabNavigationTest {
    ...
    static class ThreeButtonsComponent extends Component {
        ...
        @Override
        public void mount(Runnable onStateChange, io.github.yehorsyrin.tui.event.EventBus eventBus) {
    ...
    void noFocusableNodes_tabDoesNotThrow() {
        Component comp = new Component() {
            @Override public Node render() { return io.github.yehorsyrin.tui.node.Text.of("hello"); }
        };
        ScriptedBackend backend = new ScriptedBackend(
